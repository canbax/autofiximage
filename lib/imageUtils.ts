 ...
 */
export function applyCorrection(image: HTMLImageElement, rotation: number, crop: CropParams, outputFormat: string = 'image/png'): Promise<Blob> {
 ...
 */
export function adjustCropForRotation(image: { naturalWidth: number; naturalHeight: number }, crop: CropParams, rotationDeg: number): CropParams {
 ...
 */
export function convertImageDataToGrayscale(data: Uint8ClampedArray, width: number, height: number): Float32Array {
